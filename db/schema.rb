...
ActiveRecord::Schema.define(version: 2018_05_30_171636) do

  create_table "churches", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.string "phone"
    t.string "email"
  ...
  create_table "masses", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "day"
    t.string "schedule"
    t.string "priest"
    t.integer "church_id"
